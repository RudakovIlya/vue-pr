<template>
  <div>
    <div v-if="isPostsLoading" class="post" @click="isOpen = !isOpen">
      <div class="content">
      ...
      <comments-transition>
        <post-list-item-comments v-show="isOpen" :id="post.id" @click.stop />
      </comments-transition>
    </div>
    <div v-else key="post-skeleton" class="post">
      <div class="content">
        <div class="title">
